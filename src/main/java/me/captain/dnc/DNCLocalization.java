...
public class DNCLocalization {
    ...
    public void loadTranslations() {
        ResourceBundle dncStrings = ResourceBundle.getBundle("translations/DNCStrings", plugin.getLocale());

        for (DNCStrings key : DNCStrings.values()) {
            sStrings.put(key, dncStrings.getString(key.toString().toLowerCase()));
        }
    }
     ...
     *
     * @param key The DNCStrings Enum for the string to pull.
     *
     ...
     *
     * @param key   the DNCStrings enum to change.
     * @param value the actual changed string.
     */
